#NAME: LEO JAMU
# GUI implemented for checkin and logic
import os
import pickle
import sys
import os
...
class HOTEL_MANGMENT_checkin:
    ...
    def __init__(self):
        ...
        def chk_add():
            while True:
                ...
                if len(self.g)!= 0 and ak!=True:
                    ...
                    self.Text1.insert(INSERT, "address recorded ""\n")
                    break
                else:
                    self.Text1.insert(INSERT, "invalid input try again""\n")
        ...
        def chk_mo():
            while True:
                ...
                if self.h.isdigit() == True and len(self.h) != 0 and len(self.h) == 10:
                    self.MOBILE = self.h
                    self.Text1.insert(INSERT, "mobile number recorded""\n")
                    break
                else:
                    self.Text1.insert(INSERT, "invalid input try again""\n")
                break
        ...
        def chk_day():
            while True:
                ...
                if self.l.isdigit() == True and len(self.l) != 0:
                    ...
                    self.Text1.insert(INSERT, "days recorded""\n")
                    break
                else:
                    self.Text1.insert(INSERT, "invalid input try again ""\n")
                    break
        ...
        root.title(" TECHOLEO HOTEL MANAGMENT")
        ...
        self.Button4.place(relx=0.76, rely=0.66, height=50, width=150)
